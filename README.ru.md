...
> ### ⚡ Главная фишка
> Приложение **живёт в трее, свёрнутым**. Открывать окно не нужно.
> Просто выдели текст где угодно, нажми **`Ctrl+C`**, затем **`Ctrl+Shift+Q`** или **`Ctrl+Alt+Q`** —
> и перевод моментально всплывёт в отдельном окне.
>
> **Никаких вкладок, окон и переключения приложений. Два хоткея — и готово.**
